 ...
 */
package com.krspace.krbase.base.delegate;
...
import com.krspace.krbase.base.BaseFragment;
 ...
 *
 * @see BaseFragment
 * Created by J.Shang on 29/04/2017 14:31
...
public interface IFragment<P extends IPresenter> {
     ...
     *
     * @return 返回 {@code true}, KrBase 会自动注册 EventBus
     */
    boolean useEventBus();
