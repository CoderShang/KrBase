...
import com.krspace.krbase.base.delegate.IFragment;
...
public abstract class BaseFragment<P extends IPresenter> extends Fragment implements IFragment<P> {
    ...
    public synchronized Cache<String, Object> provideCache() {
        if (mCache == null) {
            mCache = BaseUtils.obtainAppComponentFromContext(getActivity()).cacheFactory().build(CacheType.FRAGMENT_CACHE);
        }
        return mCache;
    }
