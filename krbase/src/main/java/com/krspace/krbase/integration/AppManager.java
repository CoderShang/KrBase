...
import static com.krspace.krbase.base.Platform.DEPENDENCY_SUPPORT_DESIGN;
 ...
 * Created by J.Shang on 14/12/2016 13:50
    ...
    public void showSnackbar(String message, boolean isLong) {
        ...
        Completable.fromAction(new Action() {
            ...
            public void run() throws Exception {
                //KrBase 已将 com.android.support:design 从依赖中移除 (目的是减小 KrBase 体积, design 库中含有太多 View)
                //因为 Snackbar 在 com.android.support:design 库中, 所以如果框架使用者没有自行依赖 com.android.support:design
                //KrBase 则会使用 Toast 替代 Snackbar 显示信息, 如果框架使用者依赖了 art-autolayout 库就不用依赖 com.android.support:design 了
                ...
                if (DEPENDENCY_SUPPORT_DESIGN) {
                    ...
                    BaseUtils.makeText(mApplication, message);
                }
            }
