...
import com.krspace.krbase.base.Platform;
...
/**
 * ================================================
 * EventBus 的管理类, KrBase 核心库并不会依赖某个 EventBus, 如果您想使用 EventBus, 则请在项目中自行依赖对应的 EventBus, 如果不想使用则不依赖
 ...
 * <p>
 * Created by J.Shang on 2018/8/1 15:28
