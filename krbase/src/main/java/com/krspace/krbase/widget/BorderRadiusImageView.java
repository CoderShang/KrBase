package com.krspace.krbase.widget;
...
import com.krspace.krbase.R;


/**
 * Created by shangzhongjia on 2019/8/5.
 * 自定义 ImageView 控件，实现了圆角和边框，以及按下变色(已被注释掉)
 */
public class BorderRadiusImageView extends ImageView {
    // 图片按下的画笔
    ...
    public BorderRadiusImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public BorderRadiusImageView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        // 获取控件的属性值
        if (attrs != null) {
            TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.BorderRadiusImageView);
            borderColor = array.getColor(R.styleable.BorderRadiusImageView_ml_border_color, borderColor);
            borderWidth = array.getDimensionPixelOffset(R.styleable.BorderRadiusImageView_ml_border_width, borderWidth);
            pressAlpha = array.getInteger(R.styleable.BorderRadiusImageView_ml_press_alpha, pressAlpha);
            pressColor = array.getColor(R.styleable.BorderRadiusImageView_ml_press_color, pressColor);
            radius = array.getDimensionPixelOffset(R.styleable.BorderRadiusImageView_ml_radius, radius);
            shapeType = array.getInteger(R.styleable.BorderRadiusImageView_ml_shape_type, shapeType);
            array.recycle();
        }
