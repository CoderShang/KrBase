 ...
 */
package com.krspace.krbase.http.imageloader.glide;
...
import com.krspace.krbase.http.OkHttpUrlLoader;
...
public class GlideConfiguration extends AppGlideModule {
    ...
    public void applyOptions(@NonNull Context context, @NonNull GlideBuilder builder) {
        final AppComponent appComponent = BaseUtils.obtainAppComponentFromContext(context);
    ...
    public void registerComponents(@NonNull Context context, @NonNull Glide glide, @NonNull Registry registry) {
        ...
        AppComponent appComponent = BaseUtils.obtainAppComponentFromContext(context);
