 ...
 */
package com.krspace.krbase.http.log;
...
import com.krspace.krbase.utils.CharacterHandler;
import com.krspace.krbase.utils.LogUtils;
 ...
 * Created by J.Shang on 25/01/2018 14:51
 * <a href="mailto:jess.yan.effort@gmail.com">Contact me</a>
 * <a href="https://github.com/JessYanCoding">Follow me</a>
 * ================================================
 */
public class DefaultFormatPrinter implements FormatPrinter {
    private static final String TAG = "KrBase-HttpLog";
    ...
    private static final String[] KrBase = new String[]{"-K-", "-r-", "-B-", "-a-", "-s-", "-e-"};

    private static String computeKey() {
        if (last.get() >= 6) {
            last.set(0);
        }
        String s = KrBase[last.get()];
        last.set(last.get() + 1);
        return s;
    }
