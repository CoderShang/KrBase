 ...
 */
package com.krspace.krbase.di.module;
...
import com.krspace.krbase.http.BaseUrl;
import com.krspace.krbase.http.GlobalHttpHandler;
import com.krspace.krbase.http.imageloader.BaseImageLoaderStrategy;
import com.krspace.krbase.http.log.DefaultFormatPrinter;
import com.krspace.krbase.http.log.FormatPrinter;
import com.krspace.krbase.http.log.RequestInterceptor;
import com.krspace.krbase.integration.cache.Cache;
import com.krspace.krbase.integration.cache.CacheType;
import com.krspace.krbase.integration.cache.IntelligentCache;
import com.krspace.krbase.integration.cache.LruCache;
import com.krspace.krbase.utils.DataHelper;
 ...
 * Created by J.Shang on 2016/3/14.
...
public class GlobalConfigModule {
    ...
    ExecutorService provideExecutorService() {
        return mExecutorService == null ? new ThreadPoolExecutor(0, Integer.MAX_VALUE, 60, TimeUnit.SECONDS,
                new SynchronousQueue<Runnable>(), Util.threadFactory("KrBase Executor", false)) : mExecutorService;
    }
