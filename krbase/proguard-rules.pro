...
-keep public class * implements com.krspace.krbase.integration.ConfigModule

 #实体类不参与混淆
-keep class com.krspace.krbase.widget.** { *; } #自定义控件不参与混淆
...
-keep class * implements com.krspace.krbase.mvp.IModel {
    <methods>;
    <fields>;
}
