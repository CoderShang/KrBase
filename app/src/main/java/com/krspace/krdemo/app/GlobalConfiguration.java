 ...
 */
package com.krspace.krdemo.app;
 ...
 * Created by J.Shang on 12/04/2017 17:25
...
//    public static String sDomain = Api.APP_DOMAIN;
    ...
    public void applyOptions(@NonNull Context context, @NonNull GlobalConfigModule.Builder builder) {
        ...
        builder.baseurl(Api.APP_DOMAIN)
                //强烈建议自己自定义图片加载逻辑, 因为 art-imageloader-glide 提供的 GlideImageLoaderStrategy 并不能满足复杂的需求
                ...
                //以下方式是 KrBase 框架自带的切换 BaseUrl 的方式, 在整个 App 生命周期内只能切换一次, 若需要无限次的切换 BaseUrl, 以及各种复杂的应用场景还是需要使用 RetrofitUrlManager 框架
